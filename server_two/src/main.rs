...
async fn server_middleware(middleware_address: &str, server_addresses: Vec<&str>) {
    ...
    let server_load_socket = UdpSocket::bind("127.0.0.3:8100")
        ...
        let server_down_index: i32 = 110000;
        let server_up_index: i32 = 210000;
...
let (ll_bytes, _) = server_load_socket
    ...
    let mut I2: i32 = i32::from_be_bytes([
    ...
    if I2 > 99999 {
        if I2 < 199999 {
            ...
            if(my_load != ip_string)
                    { 
                if (message == "QUERY" && cpu_usage < I1 && cpu_usage < I2)  {
                ...
                else if(cpu_usage < I1 && cpu_usage < I2 && my_load=="")
                {
                    my_load = ip_string;
